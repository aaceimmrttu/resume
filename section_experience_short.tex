  ...
  \experience
    ...
    {June 2021} {
                      \begin{itemize}
                        ...
                        %\item Worked across teams supporting multiple languages including Java, 
                        %\item Transitioned existing infrastructure to use only hardened images in order to maintain secure development practices
